module {
  aie.device(npu1_1col) {
    ...
    // UPDATED Runtime Sequence for 64x64 Tiling
    aie.runtime_sequence(%arg0: memref<262144xbf16>, %arg1: memref<262144xbf16>, %arg2: memref<262144xf32>) {
      // Setup the Output Channel
      aiex.npu.dma_memcpy_nd(%arg2[0, 0, 0, 0][1, 1, 64, 32][0, 0, 32, 1]) {id = 0 : i64, metadata = @outC} : memref<262144xf32>
      
      // Setup the Input Channels
      aiex.npu.dma_memcpy_nd(%arg0[0, 0, 0, 0][1, 1, 64, 64][0, 0, 64, 1]) {id = 1 : i64, metadata = @inA} : memref<262144xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 0, 0, 0][1, 1, 64, 32][0, 0, 32, 1]) {id = 2 : i64, metadata = @inB} : memref<262144xbf16>
