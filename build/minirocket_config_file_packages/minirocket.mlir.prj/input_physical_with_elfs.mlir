module {
  aie.device(npu1_1col) {
    ...
    %core_0_2 = aie.core(%tile_0_2) {
      aie.end
    } {elf_file = "/home/k002/minirocket_npu/Minirocket_amd-npu_project/programming_examples/npu_project_final/minirocket.mlir.prj/main_core_0_2.elf", stack_size = 3328 : i32}
    aie.runtime_sequence(%arg0: memref<262144xbf16>, %arg1: memref<262144xbf16>, %arg2: memref<262144xf32>) {
      aiex.npu.dma_memcpy_nd(%arg2[0, 0, 0, 0][1, 1, 64, 32][0, 0, 32, 1]) {id = 0 : i64, metadata = @outC_shim_alloc} : memref<262144xf32>
      aiex.npu.dma_memcpy_nd(%arg0[0, 0, 0, 0][1, 1, 64, 64][0, 0, 64, 1]) {id = 1 : i64, metadata = @inA_shim_alloc} : memref<262144xbf16>
      aiex.npu.dma_memcpy_nd(%arg1[0, 0, 0, 0][1, 1, 64, 32][0, 0, 32, 1]) {id = 2 : i64, metadata = @inB_shim_alloc} : memref<262144xbf16>
