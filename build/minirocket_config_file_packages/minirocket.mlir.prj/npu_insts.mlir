module {
  aie.device(npu1_1col) {
    ...
    memref.global "private" constant @blockwrite_data_0 : memref<8xi32> = dense<[2048, 0, 0, 33554432, -2080374753, 33554432, 0, 33554432]>
    memref.global "private" constant @blockwrite_data_1 : memref<8xi32> = dense<[1024, 0, 0, 16777216, -2080374769, 33554432, 0, 33554432]>
